...
#define zFunctionInformation_setName(fun, val)	(zFunctionInformation_getName(fun) = val)
#define zFunctionInformation_setNunInstructions(fun, val)	(zFunctionInformation_getNunInstructions(fun) = val)
#define zFunctionInformation_setNumCycles(fun, val)	(zFunctionInformation_getNumCycles(fun) = val)
